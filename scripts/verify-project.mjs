...
const requiredFiles = [
  ...
  'src/content/codelab/elecAngle.ts',
  'src/content/codelab/threePhaseGen.ts',
  'src/content/codelab/saliencyRatio.ts',
  'src/content/codelab/vfRamp.ts',
  'src/content/codelab/unbalance.ts',
  'src/content/codelab/thd.ts',
  'src/content/codelab/copEer.ts',
  'src/components/lab/CodeLabCard.tsx',
  'src/components/insights/CodeLabProgressPanel.tsx',
