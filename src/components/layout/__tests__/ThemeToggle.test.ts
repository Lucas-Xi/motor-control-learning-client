...
describe('ThemeToggle component module', () => {
  ...
  it('当前态切换 + 还原：cycleTheme 4 次回到起点', () => {
  ...
  it('THEME_ORDER 与 ThemeToggle 的 chip 顺序一一对应（dark → light → high-contrast → projector）', () => {
